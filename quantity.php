...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .action-buttons { display: flex; gap: 1.5rem; margin-top: 1rem; }
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            addToCartBtn.addEventListener('click', () => {
                ...
                if (existingItemIndex > -1) {
                    cart[existingItemIndex].quantity = (parseInt(cart[existingItemIndex].quantity) || 0) + item.quantity;
                } else {
                    cart.push(item);
                }
                ...
                // Show Friendly Modal instead of alert
                showMessage('Added to Cart', `${item.name} has been added successfully!`);
            });
